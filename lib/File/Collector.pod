...
# Step 1: Create the C<Collector> classes
...
Step #2: Create your C<Processor> classes.
...
=regmethod new( 'dir', 'file', ..., [ 'My::Custom::Class::One', ... ], \%opts )

=regmethod new( 'dir', 'file', ..., [ 'My::Custom::Class::One', ... ] )
...
=primethod _init_processors( @_, @your_custom_file_categories )
